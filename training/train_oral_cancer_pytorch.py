...
# --- Config ---
DATA_DIR = r"D:\Disease Prediction\Dataset\oral_cancer_classification"
MODEL_SAVE_PATH = r"D:\Disease Prediction\saved_models\oral_cancer_model.pth"
CONFUSION_MATRIX_PATH = r"D:\Disease Prediction\saved_models\oral_cancer_confusion_matrix.png"
IMG_SIZE = 380 # EfficientNet-B4 Native Resolution
BATCH_SIZE = 8 # Reduced further to avoid OOM with B4
NUM_EPOCHS = 30 
LEARNING_RATE = 0.001
NUM_CLASSES = 2
...
def plot_confusion_matrix(y_true, y_pred, classes, save_path):
    ...
    plt.ylabel('True')
    plt.title('Oral Cancer Confusion Matrix')
